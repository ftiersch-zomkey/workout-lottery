        ...
        <md-list>
            ...
            <md-list-item class="md-3-line" ng-repeat="draw in group.draws">
                <div class="md-list-item-text">
                    ...
                    <md-icon md-font-set="material-icons" class="md-secondary" ng-click="markDrawAsSucceeded(draw)">check</md-icon>
                </div>
            </md-list-item>
        </md-list>
    </md-content>
        ...
        <md-list>
            ...
            <md-list-item class="md-2-line" ng-repeat="user in group.users">
                <div class="md-list-item-text">
                    ...
                    <md-icon md-font-set="material-icons" class="md-secondary">remove_circle_outline</md-icon>
                </div>
            </md-list-item>
        </md-list>
    </md-content>
